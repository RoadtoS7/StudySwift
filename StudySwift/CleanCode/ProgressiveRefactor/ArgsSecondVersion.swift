//
//  ArgsSecondVersion.swift
//  StudySwift
//
//  Created by nylah.j on 2/2/24.
//
...
public class ArgsSecondVersion {
    ...
    public func getInt(arg: Character) -> String {
        return ""
    }
